...
public class PlayerControls {
	...
	private static final double RELATIVE_CAMERA_LEVEL = 1.1;

	public static final Point3D CAMERA_OFFSET = new Point3D(0.0, - (RELATIVE_CAMERA_LEVEL - 0.5) * Main.SIZE, 0.0);
	...
	public PlayerControls(State state, Stage stage, Scene scene) {
		...
		animations = new Animations(state, camera);
